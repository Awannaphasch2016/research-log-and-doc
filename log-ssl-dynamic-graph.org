...
** =REDO: suspect that confusion matrix output is incorrect= Research Log 1: Get node classification results from the first 10000 instances (edges) of reddit with expert labels using 10 epochs.
*** Background (information and description of goal)
- note
  - Why are you doing this? What is the movitation?
  - What is your expectation of the results?
...
** =REDO: error in confusion matrix is detected.= Research Log 2: Get node classification results from the first 10000 instances (edges) of reddit with expert labels using 50 epochs.
*** Background (information and description of goal)
- note
  - Why are you doing this? What is the movitation?
  - What is your expectation of the results?
...
** =REDO: error in confusion matrix is detected.= Research Log 2: Get node classification results from the first 10000 instances (edges) of reddit with expert labels using 500 epochs.
*** Background (information and description of goal)
- note
  - Why are you doing this? What is the movitation?
  - What is your expectation of the results?
